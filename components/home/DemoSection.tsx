...
const DemoSection = () => {
  return (
    <section className="relative">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-12 lg:pt-12">
        {/* bg */}
        <div
          aria-hidden="true"
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="textcenter mb-16">
            <h3 className="font-bold text-3xl max-w-2xl mx-auto px-4 sm:px-6">
              Watch how Sommaire transfors this{" "}
              <span className="bg-linear-to-r from-rose-400 to-rose-700 bg-clip-text text-transparent">
                Next.js course PDF
              </span>{" "}
