...
const HeroSection = () => {
  return (
    <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
      <div className="relative p-[2px] overflow-hidden rounded-full bg-linear-to-r from-rose-300 via-rose-500 to-rose-800 animate-gradient-x group">
        <Badge
          variant="secondary"
      ...
      <div className="">
        <Button
          variant={"link"}
          className="text-white mt-6 text-base rounded-full sm:text-lg px-8 sm:px-10 lg:px-12 py-6 sm:py-7 lg:py-8 lg:mt-16 bg-linear-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 font-bold hover:no-underline shadow-lg transition-all duration-300">
